...
import { FaWhatsapp, FaPhone, FaEnvelope, FaBuilding, FaCopyright, FaCheckCircle } from 'react-icons/fa';

// Lista de serviços oferecidos pelo escritório
const services = [
  {
...
function App() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Aqui você pode implementar o envio do formulário para seu email ou outro serviço
    setShowSuccess(true);
    setFormData({
      name: '',
      email: '',
